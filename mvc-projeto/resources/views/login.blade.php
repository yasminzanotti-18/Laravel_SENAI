    ...
    <style>
        * {
        ...
        body {
            ...
            min-height: 100vh;
            background:
                radial-gradient(circle at top left, #ed72ef 0%, transparent 30%),
                radial-gradient(circle at bottom right, #5a116b 0%, transparent 35%),
                linear-gradient(135deg, #690a74 0%, #56044e 100%);
            display: flex;
            align-items: center;
        ...
        .background-glow {
            ...
            width: 500px;
            height: 500px;
            background: rgba(102, 6, 117, 0.25);
            filter: blur(120px);
            border-radius: 50%;
            top: -150px;
            left: -150px;
        ...
        .background-glow-2 {
            ...
            width: 450px;
            height: 450px;
            background: rgba(128, 20, 99, 0.18);
            filter: blur(120px);
            border-radius: 50%;
            bottom: -120px;
            right: -120px;
        ...
        .card {
            ...
            box-shadow:
                ...
                0 10px 20px rgba(141, 19, 179, 0.15);
        ...
        .top-icon {
            ...
            justify-content: center;
            margin: 0 auto 25px;
            box-shadow: 0 15px 30px rgba(86, 25, 112, 0.35);
        }
        ...
        .form-input:focus {
            ...
            box-shadow: 0 0 0 5px rgba(229, 37, 235, 0.12);
        ...
        .form-input:focus {
            border-color: var(--primary);
            background: var(--white);
            box-shadow: 0 0 0 5px rgba(207, 88, 175, 0.12);
            transform: translateY(-1px);
        }
        ...
        .submit-btn {
            ...
            gap: 10px;
            margin-top: 10px;
            box-shadow: 0 12px 25px rgba(139, 9, 117, 0.28);
        }

        .submit-btn:hover {
            transform: translateY(-3px);
            box-shadow: 0 18px 35px rgba(139, 40, 122, 0.4);
        }
        ...
        .decoration-line {
            ...
            height: 5px;
            border-radius: 999px;
            background: linear-gradient(to right, var(--primary), #ca8af1);
            margin: 0 auto 30px;
        }
        ...
        .submit-btn {
            ...
            justify-content: center;
            gap: 10px;
            box-shadow: 0 12px 25px rgba(142, 8, 110, 0.28);
        }

        .submit-btn:hover {
            transform: translateY(-3px);
            box-shadow: 0 18px 35px rgba(99, 4, 106, 0.4);
        }
